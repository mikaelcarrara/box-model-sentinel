...
[![Version](https://img.shields.io/badge/version-2.1.4-blue)](https://github.com/mikaelcarrara/box-model-sentinel)
...
### 2.1.4
- Fix: header da visualização ASCII exibe linha 1‑based, alinhada ao badge
- Testes atualizados para cobrir o rótulo de linha
